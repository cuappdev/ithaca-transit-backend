...
describe('Route unit tests', () => {
  routeTests.forEach((routeParams) => {
    describe(routeParams.name, () => {
      ...
      describe('RouteUtils', () => {
        test('GhopperUtils.getGraphhopperBusParams', () => {
        ...
        test('GhopperUtils.getDepartureTimeDate', () => {
          // TODO check departure time is the same as in the request
          // console.log(moment(time).format());
          expect(typeof GhopperUtils.getDepartureTimeDate(time, arriveBy)).toBe('string');
        });
